...
public class Env {
	...
	void run(String[] args){
		...
		if (TEST_1) {
			...
			sendMessage(clients[1], new ROCClientMessage("inquiry 1 1"));
			...
			sendMessage(clients[0], new ROCClientMessage("inquiry 1 2"));
			sendMessage(clients[3], new ROCClientMessage("inquiry 2 1"));
		}
